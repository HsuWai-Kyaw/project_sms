...
if (!empty($search_query)) {
     $room_query .= " WHERE room_number LIKE :search_query OR location LIKE :search_query";
}

$room_query .= " LIMIT :start_page, :record_per_page";

$s = $pdo->prepare($room_query);
...
<div class="header w-auto shadow m-auto p-3">
     <nav class="navbar navbar-expand-lg bg-body-tertiary">
          <div class="container-fluid">
               <a class="navbar-brand" href="room_index.php">room List</a>
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                         <li class="nav-item">
                              <a class="nav-link active" aria-current="page" href="room_index.php">Home</a>
                         </li>
                         <li class="nav-item">
                              <a class="nav-link" href="add_room.php">Add New +</a>
                         </li>
     ...
     <table class="table m-3 align-middle mb-0 bg-white">
          ...
          <tbody>
               ...
               <?php foreach ($results as $key => $value) { ?>
                    ...
                    <td scope="row"><?= $value['total_seats'] ?></td>
                ...
                ?>
                    ...
                    <td scope="row"><a href="room_detail.php?id=<?= $value['room_id'] ?>" class="btn btn-sm btn-info">Detail</a>
                    </td>
                    <td scope="row"> <a href="edit_room.php?id=<?= $value['room_id'] ?>" class="btn btn-sm btn-warning">Edit</a>

                    </td>
                    <td scope="row"><a href="delete.php?id=<?= $value['room_id']; ?>" class="btn btn-sm btn-danger" onclick="alert('are you sure?')">Delete</a>
...
<div class="pagination m-auto" style="width: fit-content;">
     ...
     $page_qry = "SELECT * FROM room";
     if (!empty($search_query)) {
          $page_qry .= " WHERE room LIKE :search_query OR location LIKE :search_query";
     }
